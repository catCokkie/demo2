...
public class MySQLServer {
    ...
    private final String url = "jdbc:sqlserver://localhost:3306;databaseName=dbsystem";
    private final String userName = "root";
    private final String password = "Test_1234";
    ...
    public String checkUser(String username,String password){
        ...
        try {
            ...
            rs = execSQL("select * from dbsystem.user");
        ...
        try {
            ...
            while(rs.next()){
                ...
                String temp_username = rs.getString("login_name").trim();
